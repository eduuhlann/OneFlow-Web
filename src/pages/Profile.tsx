...
const Profile: React.FC = () => {
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>, type: 'avatar' | 'banner') => {
        ...
        if (isGif) {
            handleUploadOriginal(file, type);
            return;
        }
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await updateProfile({ 
                ...
                banner_url: isPro ? (bannerUrl || null) : profile?.banner_url || null,
                ...
                <div className="bg-[#0a0a0a] rounded-[2.5rem] overflow-hidden border border-white/5 shadow-[0_0_50px_rgba(0,0,0,0.5)] relative">
                    ...
                    <div className="relative group/banner z-10">
                        ...
                        <div 
                            ...
                            onClick={() => isPro ? bannerInputRef.current?.click() : navigate('/pro')}
